Ext.define('XMLifeOperating.store.Message', {
    ...
    // data:[
    //     { 'id': '10001','content':'今天要发布系统','startTime':1414118179178,'adminName':'wwb','url':'http://www.xiaomei.com/send','file':'杭州用户UID.text','status': 0},
    //     { 'id': '10002','content':'魂牵梦萦','startTime':1414118179178,'adminName':'hoby','url':'http://www.xiaomei.com/send','file':'杭州用户UID.text','status': 0},
