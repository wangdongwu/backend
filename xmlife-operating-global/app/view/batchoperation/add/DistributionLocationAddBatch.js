Ext.define('XMLifeOperating.view.batchoperation.add.DistributionLocationAddBatch', {
  extend: 'Ext.panel.Panel',
  id : 'DistributionLocationAddBatch',
  xtype : 'DistributionLocationAddBatch',
  alias : 'widget.DistributionLocationAddBatch',
  title : '配送地址',
  closeAction: 'hide',
  resizable: false,
  forceFit: true,
