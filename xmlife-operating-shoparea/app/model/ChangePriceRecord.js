...
Ext.define('XMLifeOperating.model.ChangePriceRecord', {
    ...
    fields: ['id','shopId','shopName','skuId','productName','categoryName','shopName','proPprice','proDprice','pprice','dprice','proPrice','proDprice','dprice','updated','status','auditer','auditTime'],
    proxy: dataProxy,
});
//id
//shopId 冗余店铺ID
