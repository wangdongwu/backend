Ext.define('XMLifeOperating.controller.shopConfig', {
    ...
    models: ['Shop', 'ShopArea', 'ShopConfig', 'shopModules', 'ShopModulesItem', 'HomePageProduct'],

    stores: [
        'Shop', 'ModuleNameComplete', 'ShopArea', 'HomePageShop', 'ShopConfig',
        'ShopCopyVersion', 'shopModules', 'ShopCopyModule', 'ShopModulesItem', 'ShopUrlType',
    ...
    loadCopyModuleStore: function(layoutId) {
        var self = this;
        this.getShopCopyModuleStore().load({
            params: {
                layoutId: layoutId,
                shopId: self.shopId
            }
