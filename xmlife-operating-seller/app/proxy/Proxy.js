Ext.define('XMLifeOperating.proxy.Proxy', {
    requires: ['XMLifeOperating.base.Global'],
    ...
    constructor: function(resourceURL, root) {
        ...
        if (resourceURL == 'auth') {
            ...
            this.url = XMLifeOperating.base.Global.URL.biz + resourceURL;
        }
...
window.sendRequest = function(url, params, title, successMsg, errorMsg, success, failure) {
    ...
    if (url == 'auth') {
        ...
        newUrl = XMLifeOperating.base.Global.URL.biz + url;
    }
    Ext.Ajax.request({
        url: newUrl,
        params: params,
